...
(function () {
    ...
    var FixtureTypes = { EDGE: 0, PUCK: 1, PADDLE: 2, GOAL: 3 };
    ...
    Hockey.Physics = function (model) {
        ...
        var world = new Box2D.Dynamics.b2World(new b2Vec2(0, 0), !1);
        this.world = world;
        ...
        var cr = table.width * 0.1;
        addEdge(w - cr, -d, -w + cr, -d);
        addCornerEdge(-w + cr, -d + cr, (3 * Math.PI) / 2, cr);
        addEdge(-w, -d + cr, -w, d - cr);
        addCornerEdge(-w + cr, d - cr, Math.PI, cr);
        addEdge(-w + cr, d, w - cr, d);
        addCornerEdge(w - cr, d - cr, Math.PI * 0.5, cr);
        addEdge(w, d - cr, w, -d + cr);
        addCornerEdge(w - cr, -d + cr, 0, cr);
        var gw = model.goalSize.width * table.width;
        var gh = model.goalSize.depth * table.depth;
