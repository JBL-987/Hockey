...
(function () {
    ...
    Hockey.GameModel = function (renderer) {
        ...
        this.camera = 0;
        this.soundEnabled = !0;
        this.playerA = { score: 0, paddle: null, radius: 0 };
        this.playerB = { score: 0, paddle: null, radius: 0 };
        this.targetScore = 10;
        this.pucks = [];
        this.listeners = {};
    };
    Hockey.GameModel.STATES = { LOADING: 0, PLAYING: 1, RESTING: 2 };
    Hockey.GameModel.CAMERAS = { FRONT: 0, TOP: 1, SIDE: 2 };
    Hockey.GameModel.prototype = {
        ...
        addPuck: function (mesh, radius) {
            this.pucks.push({ mesh: mesh, radius: radius, active: !0 });
        },
        ...
        createGUI: function () {
            var gui = new dat.GUI();
            var me = this;
            gui.add(this, "camera", Hockey.GameModel.CAMERAS)
                .name("Camera")
